...
export const GET = withAuthTenant(
  withErrorHandler(async (_req: NextRequest, { tenantId }, params) => {
    return handleFhirRead(tenantId, 'MedicationRequest', (params as { id: string }).id);
  }),
...
export const PUT = withAuthTenant(
  withErrorHandler(async (req: NextRequest, { tenantId }, params) => {
    return handleFhirUpdate(req, tenantId, 'MedicationRequest', (params as { id: string }).id, fromFhirMedicationRequest);
  }),
