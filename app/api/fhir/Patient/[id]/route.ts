 ...
 * Read a single patient by logical ID.
 * Returns FhirPatient or OperationOutcome 404 if not found.
...
export const GET = withAuthTenant(
  withErrorHandler(async (_req: NextRequest, { tenantId }, params) => {
    ...
    return handleFhirRead(tenantId, 'Patient', (params as { id: string }).id);
  }),
