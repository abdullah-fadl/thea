...
import { compareLegacyClinicalInfraToCore } from '@/lib/core/units/shadowRead';
...
export const PUT = withAuthTenant(async (req: NextRequest, { tenantId, userId, user }) => {
  ...
  if (body.unitType !== undefined) {
    ...
    if (ut && UNIT_TYPES.has(ut)) patch.type = ut;
  }
