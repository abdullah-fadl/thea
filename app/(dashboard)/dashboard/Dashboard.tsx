  ...
  const roleContent = useMemo(() => {
    ...
    return {
      kpis: [
        ...
        { title: language === 'ar' ? 'المعدات' : 'Equipment', value: `${stats.equipmentOperational}%`, description: language === 'ar' ? 'جاهزية المعدات' : 'Operational rate', icon: PackagePlus, href: '/equipment-mgmt' },
