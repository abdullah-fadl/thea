// Shared types for Recruitment & AI Matching page
...
export const STATUS_CONFIG: Record<string, { label: string; color: string; icon: string }> = {
  ...
  offer: { label: 'Offer Sent', color: 'bg-orange-100 text-orange-800', icon: 'ArrowRight' },
  hired: { label: 'Hired', color: 'bg-green-100 text-green-800', icon: 'CheckCircle' },
  rejected: { label: 'Rejected', color: 'bg-red-100 text-red-800', icon: 'XCircle' },
};

export const STATUS_FLOW = ['applied', 'screening', 'interview', 'offer', 'hired'];
