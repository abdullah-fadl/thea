...
// ---------------------------------------------------------------------------
// IMDAD ROOT — Redirects to My Work (action-based landing)
// Command Center is accessible via sidebar for admin/executive users.
// ---------------------------------------------------------------------------

import { useEffect } from 'react';
import { useRouter } from 'next/navigation';

export default function ImdadRootPage() {
  const router = useRouter();

  useEffect(() => {
    router.replace('/imdad/my-work');
  }, [router]);
