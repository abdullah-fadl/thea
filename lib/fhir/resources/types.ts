...
// ---------------------------------------------------------------------------
// PractitionerRole (Phase 8.1.3 — NPHIES supporting actor)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Location (Phase 8.1.3 — NPHIES supporting actor)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// MessageHeader (Phase 8.1.3 — NPHIES envelope)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Claim (Phase 8.1.1 — NPHIES financial)
// ---------------------------------------------------------------------------
...
export interface FhirClaim extends FhirResource {
  ...
  priority: FhirCodeableConcept;
  payee?: { type: FhirCodeableConcept; party?: FhirReference };
  careTeam?: {
    sequence: number;
    provider: FhirReference;
...
// ---------------------------------------------------------------------------
// ClaimResponse (Phase 8.1.1 — NPHIES financial)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// CoverageEligibilityRequest (Phase 8.1.2 — NPHIES eligibility)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// CoverageEligibilityResponse (Phase 8.1.2 — NPHIES eligibility)
// ---------------------------------------------------------------------------
