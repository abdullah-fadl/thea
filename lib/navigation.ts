...
export const NAVIGATION_MODULES: NavigationModule[] = [
  ...
  // ── ER ──
  // Note: ER disposition and progress notes are captured inline within the
  // ER encounter (`/er/encounter/[id]`) — there is no separate page for either.
  // Their nav entries were removed in fix-nav-and-dead-config (broken links).
  {
    id: 'equipment-mgmt',
    titleKey: 'equipmentMgmt',
    descriptionKey: 'equipmentMgmtDescription',
    href: '/equipment-mgmt',
  ...
  },
  {
    id: 'px-cases',
    titleKey: 'pxCases',
    descriptionKey: 'pxCasesDescription',
  ...
  },
  {
    id: 'px-visits',
    titleKey: 'pxVisits',
    descriptionKey: 'pxVisitsDescription',
  ...
  },
  {
    id: 'px-reports',
    titleKey: 'pxReports',
    descriptionKey: 'pxReportsDescription',
  ...
  // ── Hospital Core (orphan modules wired in fix-nav-and-dead-config) ──
  {
    id: 'departments',
    titleKey: 'departments',
    descriptionKey: 'departmentsDescription',
    href: '/departments',
    requiredPermission: 'registration.view',
    icon: Network,
    category: 'Hospital Core',
  ...
  {
    id: 'physiotherapy',
    titleKey: 'physiotherapy',
    descriptionKey: 'physiotherapyDescription',
    href: '/physiotherapy',
    requiredPermission: 'physiotherapy.view',
    icon: Bone,
  ...
  },
  {
    ...
    href: '/referrals',
    requiredPermission: 'opd.visit.view',
    icon: Send,
    category: 'Clinical Services',
  },
  ...
  // ── Operations ──
  {
    id: 'handover',
    titleKey: 'handover',
    descriptionKey: 'handoverDescription',
    href: '/handover',
  ...
  // ── Document System (SAM-adjacent — surfaced for Thea Health users with
  // policies permissions; SAM users still navigate via the SAM top-nav) ──
  {
    id: 'integrity',
    titleKey: 'integrity',
  ...
  },
  {
    ...
    href: '/alignment',
    requiredPermission: 'policies.harmonization.view',
    icon: ArrowLeftRight,
    category: 'Document System',
  },
  {
