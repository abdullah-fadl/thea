...
export async function ensureResultsWriteAllowed(args: {
  ...
  try {
    ...
    // Log but allow results write to proceed if discharge check fails
  ...
  // death_declarations — already migrated to Prisma
