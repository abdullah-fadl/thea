...
export function getDefaultPermissionsForRole(role: string): string[] {
  const defaults: Record<string, string[]> = {
    ...
    // Phase 2.2 — tenant-owner can manage hospitals + branch admins under their tenant
    'tenant-owner': [
    ...
    'charge-nurse': ['er.board.view', 'er.encounter.view', 'nursing.operations.view'],
    charge_nurse: ['er.board.view', 'er.encounter.view', 'nursing.operations.view'],
