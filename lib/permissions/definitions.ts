...
export const PERMISSIONS: Permission[] = [
  ...
  // Phase 8.1.4 — NPHIES outbound HTTP send permission (gates eligibility/claim
  // submission routes + the $process-message round-trip endpoint).
  { key: 'nphies.send', label: 'NPHIES Submit', category: 'Billing', group: 'billing-main', hidden: true },
  ...
  // Nursing Operations (cross-department shift hub)
  { key: 'nursing.operations.view', label: 'Nursing Operations', category: 'Operations', group: 'nursing' },
  ...
  // ── Patient Experience ──
  // Top-level dashboard
  { key: 'px.dashboard.view', label: 'Patient Experience Dashboard', labelAr: 'لوحة تجربة المريض', category: 'Patient Experience' },

  // Cases (grouped — view/create/edit/comment/close roll up to one row)
  { key: 'px.cases.view', label: 'PX Cases', labelAr: 'حالات تجربة المريض', category: 'Patient Experience', group: 'px-cases' },
  { key: 'px.cases.create', label: 'Create PX Case', labelAr: 'إنشاء حالة', category: 'Patient Experience', group: 'px-cases', hidden: true },
  { key: 'px.cases.edit', label: 'Edit PX Case', labelAr: 'تعديل حالة', category: 'Patient Experience', group: 'px-cases', hidden: true },
  { key: 'px.cases.comment', label: 'Comment on PX Case', labelAr: 'إضافة تعليق', category: 'Patient Experience', group: 'px-cases', hidden: true },
  { key: 'px.cases.close', label: 'Close PX Case', labelAr: 'إغلاق حالة', category: 'Patient Experience', group: 'px-cases', hidden: true },

  // Visits (read-only experience signals)
  { key: 'px.visits.view', label: 'PX Visits', labelAr: 'زيارات تجربة المريض', category: 'Patient Experience' },

  // Reports + export (grouped)
  { key: 'px.reports.view', label: 'PX Reports', labelAr: 'تقارير تجربة المريض', category: 'Patient Experience', group: 'px-reports' },
  { key: 'px.reports.export', label: 'Export PX Reports', labelAr: 'تصدير التقارير', category: 'Patient Experience', group: 'px-reports', hidden: true },
];